...
public interface MiniGoListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterLoop_expr(@NotNull MiniGoParser.Loop_exprContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniGoParser#loop_expr}.
	 * @param ctx the parse tree
	 */
	void exitLoop_expr(@NotNull MiniGoParser.Loop_exprContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MiniGoParser#dec_spec}.
	 * @param ctx the parse tree
	 */
	void enterDec_spec(@NotNull MiniGoParser.Dec_specContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniGoParser#dec_spec}.
	 * @param ctx the parse tree
	 */
	void exitDec_spec(@NotNull MiniGoParser.Dec_specContext ctx);
	/**
